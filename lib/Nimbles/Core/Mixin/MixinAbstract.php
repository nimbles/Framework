 ...
 * @uses       \Nimbles\Core\Mixin\Exception\MixinableMissing
 */
abstract class MixinAbstract {
     ...
     * @return array
     * @throws \Nimbles\Core\Mixin\Exception\MixinableMissing
     */
    ...
    public function __get($property) {
        foreach ($this->getMixins() as $mixin) {
            if ($mixin->hasProperty($property)) {
                 ...
                 * @param \Nimbles\Core\Mixin\MixinAbstract $this     Reference to $this as it doesn't exist within the Closure
