...
class DirectoryTest extends \PHPUnit_Framework_TestCase {
	...
	public function testLoadConfigFileLevel1() {
		$dir = new \Mu\Config\Directory(dirname(__FILE__) . '/_files/', 'level1');
	...
	public function testLoadConfigFileLevel2() {
		$dir = new \Mu\Config\Directory(dirname(__FILE__) . '/_files/', 'level2');
	...
	public function testLoadConfigFileLevel3() {
		$dir = new \Mu\Config\Directory(dirname(__FILE__) . '/_files/', 'level3');
