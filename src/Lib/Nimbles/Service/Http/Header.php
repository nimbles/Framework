...
namespace Nimbles\Service\Http;
...
class Header extends Collection {
     ...
     * @param string $name
     * @return \Nimbles\Service\Http\Header
     * @throws \Nimbles\Service\Http\Header\Exception\InvalidName
     */
     ...
     * Sends the header
     * @return \Nimbles\Service\Http\Header
     * @throws \Nimbles\Service\Http\Header\Exception\HeadersAlreadySent
     */
