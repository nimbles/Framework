...
class TestCase extends Core\TestCase {    
    ...
    protected static function overrideHeader() {
        static::replaceFunction(
            ...
            '\Nimbles\Service\TestCase::header($header, $replace, $code);'
        );
        
        static::replaceFunction(
        	'header_remove',
        	'$name = null',
            '\Nimbles\Service\TestCase::header_remove($name);'
        );
        
        static::replaceFunction(
            'headers_list',
            '',
            'return \Nimbles\Service\TestCase::headers_list();'
        );
        
        static::replaceFunction(
            'headers_sent',
            '',
            'return \Nimbles\Service\TestCase::headers_sent();'
        );
    }
