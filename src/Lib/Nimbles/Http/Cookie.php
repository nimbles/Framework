 ...
 *
 * @uses       \Nimbles\Http\Cookie\Exception\InvalidName
 * @uses       \Nimbles\Http\Cookie\Exception\InvalidValue
 * @uses       \Nimbles\Http\Cookie\Exception\InvalidPath
 * @uses       \Nimbles\Http\Cookie\Exception\InvalidDomain
 */
class Cookie extends MixinAbstract {
     ...
     * @throws \Nimbles\Http\Cookie\Exception\InvalidName
     */
     ...
     * @param  string $value
     * @return \Nimbles\Http\Cookie
     * @throws \Nimbles\Http\Cookie\Exception\InvalidValue
     */
     ...
     * @param  string $path
     * @return \Nimbles\Http\Cookie
     * @throws \Nimbles\Http\Cookie\Exception\InvalidPath
     */
     ...
     * @param  string $domain
     * @return \Nimbles\Http\Cookie
     * @throws \Nimbles\Http\Cookie\Exception\InavlidDomain
     */
     ...
     * @param bool $raw
     * @return void
     * @throw \Nimbles\Http\Cookie\Exception\HeadersAlreadySent
     */
