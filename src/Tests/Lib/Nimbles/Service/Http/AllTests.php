...
class AllTests extends TestSuite {
    ...
    public static function suite() {
        $suite = new TestSuite('Nimbles Framework - Service - Http');
        
        $suite->addTestSuite('Tests\Lib\Nimbles\Service\Http\HeaderTest');
        $suite->addTest(Header\AllTests::suite());
        $suite->addTestSuite('Tests\Lib\Nimbles\Service\Http\ParametersTest');
