...
class HttpTest extends TestCase {
    /**
     * Tests that a the object extends Nimbles\App\Request\RequestAbstract
     * @return void
     */
    public function testAbstract() {
        $http = new Http();
        $this->assertType('Nimbles\App\Request\RequestAbstract', $http);
    }
    ...
    public function testGetSetQuery() {
        ...
        $this->assertType('Nimbles\App\Http\Parameters', $http->getQuery());
    ...
    public function testGetSetPost() {
        ...
        $this->assertType('Nimbles\App\Http\Parameters', $http->getPost());
