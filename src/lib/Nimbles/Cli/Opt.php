 ...
 *
 * @uses       \Nimbles\Cli\Request\Opt\Exception\InvalidAlias
 * @uses       \Nimbles\Cli\Request\Opt\Exception\InvalidCharacter
 * @uses       \Nimbles\Cli\Request\Opt\Exception\InvalidParameterType
 * @uses       \Nimbles\Cli\Request\Opt\Exception\Parse
 */
class Opt extends MixinAbstract {
     ...
     * @throws \Nimbles\Cli\Request\Opt\Exception\InvalidCharacter
     */
     ...
     * @param string $text
     * @return \Nimbles\Cli\Request\Opt
     * @throws \Nimbles\Cli\Request\Opt\Exception\InvalidAlias
     */
     ...
     * @param int $type
     * @return \Nimbles\Cli\Request\Opt
     * @throws \Nimbles\Cli\Request\Opt\Exception\InvalidParameterType
     */
     ...
     * @param string|\Nimbles\Cli\Request\Opt $string
     * @return \Nimbles\Cli\Request\Opt
