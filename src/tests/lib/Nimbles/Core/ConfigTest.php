...
class ConfigTest extends TestCase {
    ...
    public function testGetInstance() {
        $this->assertType('Nimbles\Core\Config', Config::getInstance());
    }
    ...
    public function testConstructWithNonArray() {
        $this->setExpectedException('\Nimbles\Core\Config\Exception\InvalidConfig');
    ...
    public function testAccessesPopulatedArray(array $testdata) {
        ...
        $this->assertType('\Nimbles\Core\Config', $config->d);
        $this->assertEquals(4, $config->d->e);
        $this->assertEquals(4, $config->{'d.e'});
        $this->assertEquals(5, $config->d->f);
        $this->assertEquals(5, $config->{'d.f'});
        $this->assertType('\Nimbles\Core\Config', $config->d->g);
        $this->assertType('\Nimbles\Core\Config', $config->{'d.g'});
    ...
    public function testGetSetConfigPopulatedArray(array $testdata) {
        ...
        $this->assertType('\Nimbles\Core\Config', $config->getConfig('d'));
        $this->assertEquals(4, $config->getConfig('d.e'));
        $this->assertEquals(5, $config->getConfig('d.f'));
        $this->assertType('\Nimbles\Core\Config', $config->getConfig('d.g'));
